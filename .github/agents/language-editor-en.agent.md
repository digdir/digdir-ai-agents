...
Review and improve English documentation following UK Government Style Guidelines and Plain Language principles. Translate from Norwegian to British English (Digdir's preferred English variant).
...
1. **Audience and Purpose** - Understand readers' background, knowledge, and goals
2. **User-Centered Writing** - Focus on what users must know, not what you want to tell them
3. **Clarity First** - Aim for communications that are easily understood and actionable
...
- Use transitional text between sections
...
- Keep sentences 15-20 words long (max 30-35)
- Prefer active voice
...
- Use high text-to-background contrast
...
- Ensure sentences have only one possible interpretation
